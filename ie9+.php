   ...
   <div class="wrapper">
            ...
            while($r = mysqli_fetch_assoc($q)) {
               ...
               <div class='note'>
                  <div class='btn_remove'>
                     <p>
                        <a href='index.php?remove=".$r['ID']."'>X</a>
                     </p>
                  </div>
                  <textarea id='title".$r['ID']."' onclick='udpate_note(".$r['ID'].")' onchange='udpate_note(".$r['ID'].")' class='title'>".$r['Title']."</textarea>
                  <textarea id='text".$r['ID']."' onclick='udpate_note(".$r['ID'].")' onchange='udpate_note(".$r['ID'].")' class='text'>".$r['Text']."</textarea>
                  <div class='status'>
                     <ul>
                        <li>
                           <a class='s_status' href='#'>".$r['Status']."</a>
                           <ul>
                              <a href='index.php?change_status=".$r['ID']."&status=0'>
                                 <li>ON HOLD</li>
                              </a>
                              <a href='index.php?change_status=".$r['ID']."&status=1'>
                                 <li>IN PROGRESS</li>
                              </a>
                              <a href='index.php?change_status=".$r['ID']."&status=2'>
                                 <li>NEEDS REVIEW</li>
                              </a>
                              <a href='index.php?change_status=".$r['ID']."&status=3'>
                                 <li>FINISHED</li>
                              </a>
                           </ul>
                        </li>
      ...
      <div id="new_note">
         <form action="index.php" method="post" class="new_note_container animate">
            <textarea class="new_note_title" name="new_note_title">Title</textarea>
            <textarea class="new_note_text" name="new_note_text">Description</textarea>
...
<script>
   ...
   function udpate_note(a) {
      var id = a;
      var new_title = document.getElementById('title'+a).value;
      var new_text = document.getElementById('text'+a).value;
      ...
      var done_typing_interval = 2000;  //time in ms
      var $input = $('textarea');
   ...
   $("nav > ul > li:eq(0)").on("click", function() {window.location.href = "index.php?name=all";});
   $("nav > ul > li:eq(1)").on("click", function() {window.location.href = "index.php?name=on hold";});
   $("nav > ul > li:eq(2)").on("click", function() {window.location.href = "index.php?name=in progress";});
   $("nav > ul > li:eq(3)").on("click", function() {window.location.href = "index.php?name=needs review";});
   $("nav > ul > li:eq(4)").on("click", function() {window.location.href = "index.php?name=finished";});
</script>
</body>
</html>